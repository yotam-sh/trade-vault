...
def get_trade_history(start_date=None, end_date=None):
    ...
    for txn in buy_sell_txns:
        ...
        trades.append({
            ...
            'name_tase_he': enriched.get('name_tase_he'),
            'name_tase_en': enriched.get('name_tase_en'),
            'name_yf_long': enriched.get('name_yf_long'),
            'name_yf_short': enriched.get('name_yf_short'),
